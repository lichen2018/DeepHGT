...
def loadSeq(file_name):
    ...
    while 1:
        ...
        sample_list.append(buf)
    for buf in sample_list:
        sample_seq_list.append(encodeSequence(buf[0]))
    sample_x = np.array(sample_seq_list)
    return sample_x
...
if __name__ == "__main__":
    ...
    optional.add_argument("-i", type=str, default="seq.txt", help="<str> DNA sequence file", metavar="\b")
    optional.add_argument("-w", type=str, default="deepHGT.h5", help="<str> weight of DeepHGT.", metavar="\b")
    optional.add_argument("-o", type=str, default="prediction.txt", help="<str> prediction file.", metavar="\b")
